...
#python -u yoloatt_train.py --epochs=8 --num_workers=8 --batch_size=32 --log_period=50 --save_period=1 --loss_weight=0.0001 --log_path=epoch_yolo2_test_1 --weight=../weights/yoloatt_v3_2_w.pth --lr=0.0005
