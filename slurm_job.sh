...
python -u yoloatt_train.py --epochs=25 --num_workers=8 --batch_size=16 --log_period=100 --save_period=1 --loss_weight=0.02 --log_path=epoch_yolo2_test_4 --weight=../weights/yoloatt_v3_2_w.pth --lr=0.0005
