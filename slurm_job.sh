...
python -u yoloatt_train.py --epochs=25 --num_workers=8 --batch_size=24 --log_period=100 --save_period=1 --loss_weight=0.02 --log_path=epoch_yolo1_test_1_withobj --weight='./!weight/yoloatt_v3_1_w5.pth' --lr=0.0001
